...
export const translations = {
  EN: {
    welcome: "Welcome to Osmania College",
    smartNav: "Smart Campus Navigation",
  ...
  HI: {
    ...
    smartNav: "स्मार्ट कैंपस नेविगेशन",
    currentPosition: "वर्तमान स्थान",
  ...
  TE: {
    ...
    smartNav: "స్మార్ట్ క్యాంపస్ నావిగేషన్",
    currentPosition: "ప్రస్తుత స్థానం",
    mainGate: "ప్రధాన ద్వారం",
